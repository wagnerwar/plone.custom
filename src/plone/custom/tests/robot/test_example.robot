...
#
#  $ bin/test -s plone.custom -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src plone.custom.testing.PLONE_CUSTOM_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/plone/custom/tests/robot/test_example.robot
#
